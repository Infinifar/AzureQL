...
- [ ] 设置中增加按账户隔离的 WebDAV 配置：服务器 URL、远程目录、文件名模板、用户名/应用密码，
  ...
  - [x] 第一阶段已完成服务器 URL、远程目录、用户名/应用密码、Keystore 加密与连接测试；当前配置为设备级，
    按账户隔离、文件名模板和自签名证书信任仍待后续实现。
...
- 本机 Linux/青龙服务端探索、设置内多账户管理、内置代码编辑器/语法高亮和网络存储备份，详见上方
