...
interface EnvRepository {
    ...
    suspend fun addEnvs(envs: List<Triple<String, String, String?>>): Result<List<EnvInfo>>
    ...
    suspend fun pinEnvs(ids: List<Int>): Result<Unit>
    suspend fun unpinEnvs(ids: List<Int>): Result<Unit>
}
